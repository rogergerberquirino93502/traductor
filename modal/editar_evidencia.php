	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-edit'></i> Editar Evidencia</h4>
		  </div>
		  <div class="modal-body">
			<form class="form-horizontal" method="post" id="editar_evidencia" name="editar_evidencia">
			<div id="resultados_ajax2"></div>
			  <div class="form-group">
				<label for="mod_codigo" class="col-sm-3 control-label">Código</label>
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="mod_codigo" name="mod_codigo" placeholder="Código de Evidencia" required>
			  ...
			  <div class="form-group">
				<label for="mod_indicio" class="col-sm-3 control-label">numero_indicio</label>
				<div class="col-sm-8">
			 ...
			 <div class="form-group">
				<label for="mod_stock" class="col-sm-3 control-label">INGRESADO</label>
				<div class="col-sm-8">
